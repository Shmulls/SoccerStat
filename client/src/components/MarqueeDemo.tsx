...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "relative w-60 sm:w-64 md:w-72 lg:w-80 cursor-pointer overflow-hidden rounded-xl border p-3 sm:p-4",
    ...
    >
      ...
      <blockquote className="mt-2 text-xs sm:text-sm line-clamp-2 sm:line-clamp-3">
        {body}
      </blockquote>
    </figure>
  );
